        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
          ...
          <div className="md:col-span-7 bg-[#FFFFFF] border-2 border-amber-600/15 rounded-3xl p-6 shadow-lg flex flex-col space-y-6">
            ...
            <div className="pt-2 space-y-3">
              <button
                type="button"
                onClick={() => console.log("Trigger Provider Google Login")}
                className="w-full py-2.5 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-bold text-xs rounded-xl transition duration-300 shadow-sm cursor-pointer flex items-center justify-center gap-2"
              >
              ...
              <div className="flex items-center gap-2 py-1">
                ...
                <span className="text-[10px] text-slate-400 uppercase font-bold">or use credentials</span>
                <div className="flex-1 h-px bg-slate-100"></div>
              </div>
            </div>
